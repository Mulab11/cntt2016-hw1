    ...
    public:
        int find(int redCount, int redHeight, int blueCount, int blueHeight) {
            if (redHeight==blueHeight){
                return redCount!=blueCount?min(redCount,blueCount)*2+1:redCount*2;
            } else{
                return redCount!=blueCount?min(redCount,blueCount)*3+1:redCount*3;
            }
            return 0;
        }
};
